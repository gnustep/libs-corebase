...
int main (void)
{
  ...
  loc = CFLocaleCreate (NULL, __CFStringMakeConstantString("en_US"));
  ...
  PASS_CFEQ(str, __CFStringMakeConstantString("16"), "SInt8 formatted correctly");
  CFRelease (str);
  ...
  PASS_CFEQ(CFNumberFormatterCreateStringWithValue (NULL, nf,
    kCFNumberSInt16Type, &int_16), __CFStringMakeConstantString("$300.00"),
  ...
  int_32 = 68456;
  PASS_CFEQ(CFNumberFormatterCreateStringWithValue (NULL, nf,
    kCFNumberSInt32Type, &int_32), __CFStringMakeConstantString("6.8456E4"),
  ...
  int_64 = 315000000;
  PASS_CFEQ(CFNumberFormatterCreateStringWithValue (NULL, nf,
    kCFNumberSInt64Type, &int_64), __CFStringMakeConstantString("315,000,000"),
  ...
  d = 1.234;
  PASS_CFEQ(CFNumberFormatterCreateStringWithValue (NULL, nf,
    kCFNumberDoubleType, &d), __CFStringMakeConstantString("123%"),
